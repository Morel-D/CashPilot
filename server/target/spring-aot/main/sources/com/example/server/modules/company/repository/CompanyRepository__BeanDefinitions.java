...
/**
 * Bean definitions for {@link CompanyRepository}.
 */
@Generated
public class CompanyRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'companyRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getCompanyRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'companyRepository'.
   */
  public static BeanDefinition getCompanyRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, CompanyRepository.class, Company.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.server.modules.company.repository.CompanyRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.CompanyRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.server.modules.company.repository.CompanyRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getCompanyRepositoryInstanceSupplier();
