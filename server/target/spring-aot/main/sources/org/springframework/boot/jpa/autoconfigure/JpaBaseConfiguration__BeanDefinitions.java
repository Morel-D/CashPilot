...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.server.modules.auth.model.RefreshToken", "com.example.server.modules.auth.model.User", "com.example.server.modules.company.model.Company", "com.example.server.modules.customer.model.Customer", "com.example.server.modules.invoice.model.Invoice", "com.example.server.modules.ledger.model.LedgerEntry", "com.example.server.modules.payment.model.Payment");
