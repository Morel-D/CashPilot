...
export default function TransactionsPage() {
  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6">
      ...
      {/* Header */}
      <div>
        <h2 className="font-display text-xl md:text-2xl font-light text-dark">Transactions</h2>
      ...
      <div className="grid grid-cols-3 gap-3 md:gap-4">
        ...
        <div className="card flex flex-col gap-1 p-3 md:p-6">
          <div className="flex items-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-2.5 md:size-3 text-emerald-500 shrink-0">
            ...
            <span className="field-label text-[9px] md:text-[11px]">Total in</span>
          </div>
          <span className="amount text-sm md:text-xl font-semibold text-dark leading-tight">
            {currency} {totals.credit.toLocaleString('en', { minimumFractionDigits: 2 })}
          </span>
          <span className="font-sans text-[10px] md:text-xs text-neutral-text-muted">This page</span>
        </div>

        <div className="card flex flex-col gap-1 p-3 md:p-6">
          <div className="flex items-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-2.5 md:size-3 text-red-500 shrink-0">
            ...
            <span className="field-label text-[9px] md:text-[11px]">Total out</span>
          </div>
          <span className="amount text-sm md:text-xl font-semibold text-dark leading-tight">
        ...
        <div className="card flex flex-col gap-1 p-3 md:p-6">
          <span className="field-label text-[9px] md:text-[11px]">Net</span>
          <span className="amount text-sm md:text-xl font-semibold text-dark leading-tight">
          ...
          <div>
            ...
            <p className="font-sans text-sm text-neutral-text-muted mt-1">
              {typeFilter
                ...
                : 'Transactions will appear here once invoices are processed.'}
            </p>
          </div>
        </div>
      ) : (
