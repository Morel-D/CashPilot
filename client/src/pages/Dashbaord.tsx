...
function EmptyBlock({ label }: { label: string }) {
  return (
    <div className="info-zone flex flex-col items-center justify-center py-10 gap-2">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="size-7 text-neutral-text-muted/30">
...
export default function DashboardPage() {
  ...
  const STATS: StatCardProps[] = [
    ...
    {
      label:   'Outstanding',
      value:   fmt(metrics?.outstandingAmount ?? 0),
      note:    'Issued & sent, unpaid',
      loading,
      accent:  'warning',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="card flex flex-col gap-4">
          ...
          <EmptyBlock label="No pending invoices." />
        </div>
      </div>
