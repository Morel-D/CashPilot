    ...
    <div className="card p-0 overflow-hidden flex flex-col">
          ...
          <thead>
            <tr className="border-b border-dark/[0.06]">
              {['Customer', 'Email', 'Phone', ''].map((h) => (
                <th
                  key={h}
                  className="px-4 py-3 font-sans text-[11px] font-semibold uppercase tracking-wider text-neutral-text-muted"
                >
                  {h}
                </th>
              ))}
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-dark/[0.06]">
        <span className="font-sans text-xs text-neutral-text-muted">
          {from}–{to} of {totalElements} customers
        </span>
        <div className="flex items-center gap-1">
          ...
          <span className="font-mono text-xs text-dark px-2">
            {number + 1} / {totalPages}
          </span>
          <Button
            variant="outline"
